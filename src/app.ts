 ...
 */
export default class PuzzlePieces {
	private text: MRE.Actor = null;
	private tl: MRE.Actor = null;
		...
		const spinAnimData = this.assets.createAnimationData(
			...
			"Spin",
			{
				...
				tracks: [{
					...
					target: MRE.ActorPath("tl").transform.local.rotation,
					// And the rotation will be set to spin over 20 seconds
					keyframes: this.generateSpinKeyframes(40, MRE.Vector3.Up()),
